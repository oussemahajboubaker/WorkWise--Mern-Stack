...
const Container = styled.div`
    width: 100%;
    background-image: linear-gradient(38.73deg, rgba(255, 85, 255, 0.25) 0%, rgba(255, 0, 128, 0) 50%), 
                      linear-gradient(141.27deg, rgba(0, 153, 255, 0) 50%, rgba(0, 153, 255, 0.25) 100%);
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
const Top = styled.div`
    ...
    flex-direction: column;
    align-items: center;
    background: linear-gradient(38.75deg, rgba(255, 85, 255, 0.15) 0%, rgba(255, 0, 128, 0) 50%),
                linear-gradient(148.27deg, rgba(0, 153, 255, 0) 50%, rgba(0, 153, 255, 0.15) 100%);
    clip-path: polygon(0 0, 100% 0, 100% 100%,50% 95%, 0 100%);
    @media (max-width: 768px) {
        clip-path: polygon(0 0, 100% 0, 100% 100%,50% 98%, 0 100%);
        padding-bottom: 0px;
